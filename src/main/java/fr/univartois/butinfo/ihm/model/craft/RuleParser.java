...
public final class RuleParser {
    ...
    /**
     * Le constructeur permettant de créer un objet {@link Crafter} à partir des règles
     * lues dans le fichier.
     */
    private final CrafterBuilder crafterBuilder;
    ...
    public RuleParser(String fileName) {
        ...
        this.crafterBuilder = CrafterBuilder.newInstance();
    }
    ...
    private void addRule(String rule, String product, int quantity) {
        crafterBuilder.withRule(rule, product, quantity);
    }

    /**
     * Donne l'objet {@link Crafter} ayant été créé à partir des règles lues dans le
     * fichier.
     *
     * @return L'objet {@link Crafter} ayant été créé.
     */
    public Crafter getCrafter() {
        return crafterBuilder.build();
    }
